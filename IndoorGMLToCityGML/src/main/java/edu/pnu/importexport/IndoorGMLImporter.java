...
public class IndoorGMLImporter {
	...
	public void importIndoorGML(String id, String filePath) throws Exception {
		...
		if(indoorFeatureType != null){
			...
			analyzer.cellSpaceSemanticAnalyze();
			System.out.println("CellSpace Semantic Analyze end");
			
			analyzer.boundarySemanticAnalyze();
			System.out.println("CellBoundary Semantic Analyze end");
			
			building = analyzer.generateBuilding();	
			System.out.println("Building was generated.");
		}
